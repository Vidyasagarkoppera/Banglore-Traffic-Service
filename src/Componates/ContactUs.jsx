...
const ContactUs = () => {
  ...
  const sendMail = () => {
    window.location = "mailto:vidyasagarkoppera@gmail.com";
  }

  const copyMail = () => {
    navigator.clipboard.writeText("vidyasagarkoppera@gmail.com")
    alert("Mail copied successfully")
  }
  const callNow = () => {
    window.open('tel:+91 630103037');
  }
  const copyContact = () => {
    navigator.clipboard.writeText("+91 630103037")
          ...
          <div className="card reachUsCard shadow-lg">
            <div className="card-body d-flex flex-column justify-content-center">
              <div className="reachUsContent text-center">
                ...
                <h5 className='text-primary'>vidyasagarkoppera@gmail.com</h5>
          ...
          <div className="card reachUsCard shadow-lg">
            <div className="card-body d-flex flex-column justify-content-center">
              <div className="reachUsContent text-center">
                ...
                <h5 className='text-info '>+91 630103037</h5>
